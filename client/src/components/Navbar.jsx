            ...
            <nav className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`}>
                <div className="navbar-inner">
                    <div className="navbar-brand" onClick={() => onNavigate('/')}>
                        <img src={logo} alt="Prexiza AI" className="navbar-logo-img" style={{ height: '36px', width: '36px', objectFit: 'contain', flexShrink: 0 }} />
                        <span className="navbar-title">Prexiza AI</span>
                    </div>
