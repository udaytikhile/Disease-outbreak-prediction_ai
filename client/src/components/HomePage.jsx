...
import parkinsonsImg from '../assets/parkinsons.png'
...
const HomePage = ({ onSelectDisease, onViewHistory, onViewProfile, onViewTips, onViewDashboard, onViewChecker, userName }) => {
    const diseases = [
        ...
        },
        {
            id: 'diabetes',
            name: 'Diabetes',
            description: 'Metabolic disorder screening through glucose metrics, BMI analysis, and hereditary risk factors.',
            image: diabetesImg,
            color: '#3b82f6',
            params: '8',
            accuracy: '78%',
        ...
        },
        {
            ...
            description: 'Neurological assessment utilizing advanced voice biomarker analysis and motor function indicators.',
            image: parkinsonsImg,
            color: '#8b5cf6',
            params: '22',
            accuracy: '87%',
    ...
    return (
        <div className="clinical-homepage">
            ...
            <section className="clinical-features-section">
                <div className="clinical-container">
                    <h2 className="clinical-section-title">Why Choose Prexiza AI?</h2>
                ...
                <div className="clinical-container">
                    <div className="clinical-footer-grid">
                        <div className="clinical-footer-brand">
                            <img src="/logo.png" alt="Prexiza AI" className="footer-logo-img" style={{ height: '40px', width: 'auto', objectFit: 'contain' }} />
                            <h3>Prexiza AI</h3>
                        ...
                        <div className="clinical-footer-col">
                            ...
                            <button className="footer-social-link" onClick={() => window.open('https://github.com/udaytikhile', '_blank')}>
                                <span className="footer-social-icon">
                            ...
                            <button className="footer-social-link" onClick={() => window.open('https://www.linkedin.com/in/uday-tikhile-b63159374', '_blank')}>
                            ...
                            <button className="footer-social-link" onClick={() => window.open('https://www.instagram.com/uday_tikhile_21?igsh=ZmNmaXRlZjF2aXhl', '_blank')}>
