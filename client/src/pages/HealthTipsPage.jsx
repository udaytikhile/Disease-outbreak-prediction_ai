...
const HealthTips = ({ onClose }) => {
    const diseases = [
        ...
        },
        {
            ...
            icon: '🫘',
            color: '#10b981',
            overview: 'Chronic kidney disease (CKD) means your kidneys are damaged and can\'t filter blood the way they should.',
            riskFactors: [
                { name: 'Diabetes', severity: 'high', icon: '💉' },
                { name: 'High Blood Pressure', severity: 'high', icon: '🩸' },
                { name: 'Heart Disease', severity: 'medium', icon: '❤️' },
                { name: 'Family History', severity: 'medium', icon: '👨‍👩‍👧‍👦' },
                { name: 'Obesity', severity: 'low', icon: '⚖️' },
            ],
            symptoms: ['Fatigue', 'Swollen ankles or feet', 'Puffiness around eyes', 'Frequent urination (especially at night)', 'Foamy urine', 'Blood in urine'],
            prevention: [
            ...
            foods: {
                good: ['Cauliflower', 'Blueberries', 'Sea Bass', 'Red Grapes', 'Egg Whites', 'Garlic'],
                avoid: ['Dark Colas', 'Avocados', 'Canned Foods', 'Whole Wheat Bread', 'Brown Rice', 'Bananas']
            },
            emergencySigns: ['Severe shortness of breath', 'Chest pain', 'Nausea and vomiting', 'Sudden confusion']
        },
        {
            id: 'depression',
            name: 'Depression',
            icon: '🧠',
            color: '#8b5cf6',
            overview: 'Depression is a common and serious medical illness that negatively affects how you feel, the way you think and how you act.',
            riskFactors: [
                { name: 'Family History', severity: 'high', icon: '👨‍👩‍👧‍👦' },
                { name: 'Major Life Changes', severity: 'high', icon: '🔄' },
                { name: 'Chronic Illness', severity: 'medium', icon: '🏥' },
                { name: 'Substance Abuse', severity: 'medium', icon: '🍷' },
                { name: 'High Stress', severity: 'low', icon: '😰' }
            ],
            symptoms: ['Persistent sad or "empty" mood', 'Loss of interest in activities', 'Significant weight loss or gain', 'Sleep disturbances', 'Fatigue or loss of energy', 'Difficulty concentrating'],
            prevention: [
            ...
            foods: {
                good: ['Fatty Fish', 'Dark Chocolate', 'Fermented Foods', 'Bananas', 'Oats', 'Berries'],
                avoid: ['Processed Meats', 'Refined Sugars', 'Excess Caffeine', 'Alcohol', 'Artificial Sweeteners']
            },
            emergencySigns: ['Thoughts of self-harm', 'Suicidal ideation', 'Severe panic attacks', 'Inability to perform basic daily tasks']
        }
    ]
