                ...
                <div className="clinical-container">
                    ...
                    <div className="clinical-features-grid">
                        {features.map((feature, index) => (
                            <div key={index} className="clinical-feature-card" style={{ '--i': index }}>
                                <div className="clinical-feature-img-wrap">
                                    <img src={feature.image} alt={feature.title} className="clinical-feature-img" width="400" height="160" loading="lazy" />
                    ...
                    <div className="clinical-disease-grid">
                        {diseases.map((disease, index) => (
                            <button
                                ...
                                style={{ '--card-color': disease.color, '--i': index }}
                                ...
                                <div className="clinical-disease-body">
                                    {disease.image ? (
                                        <div className="clinical-disease-img-wrap">
                                            <img src={disease.image} alt={disease.name} className="clinical-disease-img" width="600" height="180" loading="lazy" />
                                        </div>
                                    ) : (
                ...
                <div className="clinical-container">
                    <div className="clinical-footer-grid">
                        ...
                        <div className="clinical-footer-col">
                            ...
                            <a href="https://github.com/udaytikhile" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="GitHub (opens in new tab)">
                                <span className="footer-social-icon">
                            ...
                            <a href="https://www.linkedin.com/in/uday-tikhile-b63159374" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="LinkedIn (opens in new tab)">
                            ...
                            <a href="https://www.instagram.com/uday_tikhile_21?igsh=ZmNmaXRlZjF2aXhl" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram (opens in new tab)">
